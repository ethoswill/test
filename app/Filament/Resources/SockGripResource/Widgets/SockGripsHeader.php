...
namespace App\Filament\Resources\SockGripResource\Widgets;
...
class SockGripsHeader extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.sock-grip-resource.widgets.sock-grips-header';
