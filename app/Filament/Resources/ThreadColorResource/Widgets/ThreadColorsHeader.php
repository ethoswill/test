...
namespace App\Filament\Resources\ThreadColorResource\Widgets;
...
class ThreadColorsHeader extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.thread-color-resource.widgets.thread-colors-header';
