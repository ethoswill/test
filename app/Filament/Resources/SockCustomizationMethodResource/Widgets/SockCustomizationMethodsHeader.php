...
class SockCustomizationMethodsHeader extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.sock-customization-method-resource.widgets.sock-customization-methods-header';
    ...
    public function mount(): void
    {
        ...
        $teamNote = TeamNote::firstOrCreate(
            ['page' => 'sock-customization-methods'],
            ['content' => '']
        );
