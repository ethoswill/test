...
class ManageContactInfos extends ManageRecords
{
    ...
    protected static string $view = 'filament.resources.contact-info-resource.pages.manage-contact-infos';
    
    public function getContactInfo()
    {
        return ContactInfoModel::active()->ordered()->get();
    }
    
    public function getIconPath($iconName)
    {
        $icons = [
            'chat' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />',
            ...
            'box' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />',
