...
namespace App\Filament\Resources\PackagingResource\Widgets;
...
class PackagingHeader extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.packaging-resource.widgets.packaging-header';
