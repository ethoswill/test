...
class HexCodeColors extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.dtf-in-house-print-resource.widgets.hex-code-colors';
    ...
    public function editContent(): Action
    {
        return Action::make('edit_content')
            ...
            ->action(function (array $data): void {
                $widget = DtfWidgetContent::firstOrNew(['widget_name' => 'hex_code_colors']);
            ...
            ->modalHeading('Edit Hex Code Colors')
