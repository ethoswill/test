...
namespace App\Filament\Resources\ThreadBookColorResource\Widgets;
...
class ThreadBookColorsHeader extends Widget implements HasActions
{
    use InteractsWithActions;

    protected static string $view = 'filament.resources.thread-book-color-resource.widgets.thread-book-colors-header';
